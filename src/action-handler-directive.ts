...
customElements.define('action-handler-inventory', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-inventory')) {
    return body.querySelector('action-handler-inventory') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-inventory');
